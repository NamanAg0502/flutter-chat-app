...
class AppColors {
  ...
  static const Color appBlue = Color(0xFF1f5bfd);
  static const Color appBg = Color(0xFF252331);
  static const Color appBg2 = Color(0xFF747380);
  static const Color appNav = Color(0xFF2c2a31);
  static const Color appText = Color(0xFFe1e1ee);
}
